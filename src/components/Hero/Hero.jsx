...
import logo from '../../assets/TECH_UDBHAV_TEXT-removebg-preview.png';
    ...
    <section id="home" className={classes.hero}>
      <div className={classes.herobox}>
        <div className={classes.headerbox}>
          ...
          <img src={logo} className={classes.text_img} alt="text_img" />

          <h4 className={classes.caption}>Let&apos;s make a tech move!</h4>
          <p className={classes.date}>May 3-4-5, 2024</p>
          <Link
